...
<head>
 ...
 <main class="news-main">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center">
                        <h1 class="display-4 fw-bold mb-4">НОВОСТИ</h1>
                        <p class="lead">Последние достижения и прорывы в области кибермедицины</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="news-grid py-5">
            <div class="container">
                <div class="row g-4">
                    <!-- Первая успешная прививка киберимплантов -->
                    <div class="col-md-6 col-lg-4">
                        <div class="news-card">
                            <div class="news-image">
                                <img src="/web/img/news/8e832b55c9f9b0d7a5e8800be7e3a80c.jpg" alt="Киберимпланты" class="img-fluid">
                    ...
                    <!-- Прорыв в разработке бионических конечностей -->
                    <div class="col-md-6 col-lg-4">
                        <div class="news-card">
                            <div class="news-image">
                                <img src="/web/img/news/ee6146561e02852feaa0a6b1dd8d3342.jpg" alt="Бионические конечности" class="img-fluid">
                    ...
                    <!-- Успешная операция по установке нейроинтерфейса -->
                    <div class="col-md-6 col-lg-4">
                        <div class="news-card">
                            <div class="news-image">
                                <img src="/web/img/news/353675_3TkLETKDiu_head_back_cyberware.png" alt="Нейроинтерфейс" class="img-fluid">
