...
<head>
    ...
    <link rel="stylesheet" href="/web/css/doctors.css">
</head>
  <!-- Main Content -->
  <main class="rippers-main">
        <!-- Hero Section -->
        <section class="rippers-hero">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center">
                        <h1 class="display-4 fw-bold mb-4">НАШИ РИПЕРЫ</h1>
                        <p class="lead">Профессионалы кибермедицины, которые помогут вам выйти за пределы человеческих возможностей</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- Rippers Grid -->
        <section class="rippers-grid py-5">
            <div class="container">
                <div class="row g-4 justify-content-center">
                    <!-- Виктор -->
                    <div class="col-md-6 col-lg-3">
                        <div class="ripper-card">
                            <div class="ripper-image">
                                <img src="/web/img/doctors/Viktor-Vektor-Cyberpunk-2077.jpg" alt="Виктор" class="img-fluid">
                            </div>
                            <div class="ripper-body">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="ripper-card">
                            <div class="ripper-image">
                                <img src="/web/img/doctors/95020-artist-artwork-cyberpunk-hd-4k-artstation.jpg" alt="Алиса" class="img-fluid">
                            </div>
                            <div class="ripper-body">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="ripper-card">
                            <div class="ripper-image">
                                <img src="/web/img/doctors/3F3F_3F3F3F_3F3F3F3F29.jpg" alt="Милт Науман" class="img-fluid">
                            </div>
                            <div class="ripper-body">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="ripper-card">
                            <div class="ripper-image">
                                <img src="/web/img/doctors/3F3F283F3F3F29.jpg" alt="Рафаэль Перес" class="img-fluid">
                            </div>
                            <div class="ripper-body">
        ...
        <!-- CTA Section -->
        <section class="rippers-cta py-5 bg-dark text-white">
            <div class="container text-center">
                <h2 class="mb-4">Готовы к кибермодификациям?</h2>
                <p class="lead mb-5">Наши риперы помогут вам выйти за пределы человеческих возможностей с помощью передовых технологий</p>
                <a href="#" class="btn btn-primary btn-lg">Связаться с нами</a>
            </div>
        </section>
    </main>